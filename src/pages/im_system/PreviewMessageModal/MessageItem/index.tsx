...
import { GroupMemberItem, MergeElem } from 'open-im-sdk/lib/types/entity';
...
const MessageItem: FC<IMessageItemProps> = ({ message, isSender, showAlbum, showMergeModal }) => {
  ...
  return (
    ...
    >
      ...
      {message.errCode && (
        <div className="absolute bottom-1 left-1/2 flex -translate-x-1/2 items-center text-xs"></div>
      )}
    </div>
  );
};
