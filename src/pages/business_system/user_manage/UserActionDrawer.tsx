...
const AddUserPage = memo(
  ({ closeDrawer, reload }: { closeDrawer: () => void; reload: () => void }) => {
      ...
      <div>
        <div>
          ...
          >
            ...
            >
              <Input maxLength={15} placeholder="请输入用户昵称" />
            </Form.Item>
            ...
            <Form.Item className={'no_mb'} label={'手机号'}>
              <Space.Compact>
  ...
  return (
    ...
    >
      {drawerOptions.selectUser ? (
        ...
        <AddUserPage closeDrawer={closeDrawer} reload={reload} />
      )}
    </Drawer>
  );
};
